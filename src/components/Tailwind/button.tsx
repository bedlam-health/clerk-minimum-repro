...
const styles = {
  base: [
    ...
    // Sizing
    "px-[calc(theme(spacing[3.5])-1px)] py-[calc(theme(spacing[2.5])-1px)] sm:px-[calc(theme(spacing[5])-1px)] sm:py-[calc(theme(spacing[2.5])-1px)] sm:text-base/6",
    // Focus
  ...
  colors: {
    steelblue: [
      "text-white [--btn-hover-overlay:theme(colors.white/10%)] [--btn-bg:theme(colors.steelblue.DEFAULT)] [--btn-border:theme(colors.steelblue.DEFAULT/90%)]",
      "[--btn-icon:theme(colors.white/60%)] data-[active]:[--btn-icon:theme(colors.white/80%)] data-[hover]:[--btn-icon:theme(colors.white/60%)]",
    ],
    rosered: [
      "text-white [--btn-hover-overlay:theme(colors.white/10%)] [--btn-bg:theme(colors.rosered.DEFAULT)] [--btn-border:theme(colors.rosered.DEFAULT/90%)]",
      "[--btn-icon:theme(colors.white/60%)] data-[active]:[--btn-icon:theme(colors.white/80%)] data-[hover]:[--btn-icon:theme(colors.white/60%)]",
    ],
    carrotorange: [
      "text-white [--btn-hover-overlay:theme(colors.white/10%)] [--btn-bg:theme(colors.carrotorange.DEFAULT)] [--btn-border:theme(colors.carrotorange.DEFAULT/90%)]",
      "[--btn-icon:theme(colors.white/60%)] data-[active]:[--btn-icon:theme(colors.white/80%)] data-[hover]:[--btn-icon:theme(colors.white/60%)]",
    ],
    applegreen: [
      "text-white [--btn-hover-overlay:theme(colors.white/10%)] [--btn-bg:theme(colors.applegreen.DEFAULT)] [--btn-border:theme(colors.applegreen.DEFAULT/90%)]",
      "[--btn-icon:theme(colors.white/60%)] data-[active]:[--btn-icon:theme(colors.white/80%)] data-[hover]:[--btn-icon:theme(colors.white/60%)]",
    ],
    "dark/zinc": [
